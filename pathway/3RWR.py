...
out_dir = f"/proj/c.zihao/work2/1pathway/2pertu/{cancer_type}/pathway/2RWR/"
...
for dataset_name in dataset_ids:
    ...
    # ---- Node wide: Node as rows, sample columns = Score ----
